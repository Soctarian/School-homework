...
protected:
	...
	afx_msg void CorpusBoat(int X1, int Y1, int X2, int Y2, int DX, int DY);
	afx_msg void ElluminateBoat(int X1, int Y1, int DX, int DY);
	afx_msg void MainBoat(int X1, int Y1, int X2, int Y2, int DX, int DY);
